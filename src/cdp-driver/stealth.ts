...
export function buildStealthInitScript(): string {
  return [
    ...
    '      var w=m.width+_dx*0.01;',
    '      return {width:w,actualBoundingBoxLeft:m.actualBoundingBoxLeft,actualBoundingBoxRight:m.actualBoundingBoxRight,actualBoundingBoxAscent:m.actualBoundingBoxAscent,actualBoundingBoxDescent:m.actualBoundingBoxDescent};',
    '    };',
    '  }catch(e){}',
    '  try{',
